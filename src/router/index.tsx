            ...
            children: [
              ...
              },
              {
                ...
                async lazy() {
                  ...
                  return { Component: KnowledgeSegmentSetting };
                },
              },
              {
                path: "ai/image",
                async lazy() {
                  let { ImageSetting } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: ImageSetting };
                },
              },
              {
                path: "ai/role",
                async lazy() {
                  let { ChatRoleSetting } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: ChatRoleSetting };
                },
              },
              {
                path: "ai/tool",
                async lazy() {
                  let { ToolSetting } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: ToolSetting };
                },
              },
              {
                path: "ai/conversation",
                async lazy() {
                  let { ChatConversationSetting } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: ChatConversationSetting };
                },
              },
              {
                path: "ai/message",
                async lazy() {
                  let { ChatMessageSetting } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: ChatMessageSetting };
                },
              },
            ],
          },
