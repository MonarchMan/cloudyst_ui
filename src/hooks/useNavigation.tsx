...
export const defaultPath = "cloudyst://my";
export const defaultTrashPath = "cloudyst://trash";
export const defaultSharedWithMePath = "cloudyst://" + Filesystem.shared_with_me;
