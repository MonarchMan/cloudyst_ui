...
import { OrderDirection } from "./dashboard.ts";
import { User, UserInfo } from "./user.ts";
...
export interface WopiActionMap {
  actions: {
    [key: string]: string;
  };
}
...
export interface TestThumbGeneratorResponse {
  version: string;
}
