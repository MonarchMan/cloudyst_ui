        ...
        <Container maxWidth="sm">
          <ShareContainer>
            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", py: 2, px: 1 }}>
              <UserAvatar enablePopover overwriteTextSize sx={{ width: 56, height: 56 }} user={
                {
                  id: shareInfo.owner_id,
                  nickname: shareInfo.owner_info.nickname,
                  avatar: shareInfo.owner_info.avatar,
                  status: shareInfo.owner_info.status,
                  created_at: ""
                }
              } />
                ...
                <Trans
                  ...
                  components={[
                    <Link
                      ...
                      to={`/profile/${shareInfo.owner_id}`}
                    >
                      {shareInfo.owner_info.nickname}
                    </Link>,
                  ]}
                  values={{ nick: shareInfo.owner_info.nickname, num: 1 }}
                />
              </Typography>
              <Box
                sx={{
