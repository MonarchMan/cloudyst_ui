                    ...
                    {index == FileManagerIndex.main && (
                      <>
                        <TreeFiles
                          flatten
                          level={0}
                          path={"cloudyst://my/?category=image"}
                          key={"cloudyst://my/?category=image"}
                        />
                        <TreeFiles
                          flatten
                          level={0}
                          path={"cloudyst://my/?category=video"}
                          key={"cloudyst://my/?category=video"}
                        />
                        <TreeFiles
                          flatten
                          level={0}
                          path={"cloudyst://my/?category=audio"}
                          key={"cloudyst://my/?category=audio"}
                        />
                        <TreeFiles
                          flatten
                          level={0}
                          path={"cloudyst://my/?category=document"}
                          key={"cloudyst://my/?category=document"}
                        />
                      </>
                    )}
                    {!disableSharedWithMe && (
