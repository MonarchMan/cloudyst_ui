...
import { File, FileModel } from "../../../../api/dashboard";
...
const EntityFileList = ({ files, userHashIDMap }: { files: FileModel[]; userHashIDMap: Record<number, string> }) => {
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                      <UserAvatar
                        ...
                        user={{
                          ...
                          nickname: option.owner_info?.nickname ?? "",
                          created_at: option.owner_info?.created_at ?? "",
                        }}
                      />
