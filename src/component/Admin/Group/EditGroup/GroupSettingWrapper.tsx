...
import { Group, StoragePolicy } from "../../../../api/dashboard.ts";
...
const groupValueFilter = (group: Group): Group => {
  return {
    ...group,
    edges: {
      storage_policies: {
...
const GroupSettingWrapper = ({ groupID, children, onGroupChange }: GroupSettingWrapperProps) => {
  ...
  const [modifiedValues, setModifiedValues] = useState<Group>({
    ...defaultGroup,
  });
