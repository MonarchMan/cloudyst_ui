  ...
  return (
    <TableContainer component={StyledTableContainerPaper} sx={{ maxHeight: "300px" }}>
      ...
      <Table size="small" stickyHeader sx={{ width: "100%", tableLayout: "fixed" }}>
        ...
        <TableBody>
          {values?.file?.entities?.map((option, index) => (
              ...
              <TableCell>
                <NoWrapTypography variant="inherit">
                  <Link
                    ...
                    to={`/admin/policy/${option.storage_policy?.id}`}
                  >
                    {option.storage_policy?.name ?? ""}
                  </Link>
                </NoWrapTypography>
              </TableCell>
              <TableCell>
              ...
              <TableCell>
                <NoWrapTypography variant="inherit">
                  <Link
                    ...
                    href="#/"
                    onClick={handleUserDialogOpen(option.created_by ?? 0)}
                  >
                    {option.created_by ?? ""}
                  </Link>
                </NoWrapTypography>
